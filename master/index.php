    ...
    <div class="container" style="border-radius: 18px;background: rgba(255,255,255,0.28);">
        <div class="row">
            <div class="col-md-12">
                ...
                <nav class="navbar navbar-light navbar-expand-lg navigation-clean-button" style="background: rgba(255,255,255,0);">
                    <div class="container"><a class="navbar-brand" href="#">ADMIN</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        ...
        <div class="row">
            <div class="col-md-12" style="height: 520px;">
                <!-- Start: Simple Slider -->
                <div class="simple-slider" style="border-radius: 21px;background: rgba(255,255,255,0);">
                    <!-- Start: Slideshow -->
