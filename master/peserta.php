...
<head>
    ...
    <script src="../assets/js/peserta_script.js"></script>
...
<body class="d-flex d-xxl-flex justify-content-center align-items-center justify-content-xxl-center align-items-xxl-center" style="background: url(&quot;../assets/img/admin_bg.png?h=d48309209de4b47e32bdb528503ca658&quot;) center / cover no-repeat;height: 832px;">
    ...
    <div class="container" style="border-radius: 14px;background: rgba(255,255,255,0.25);">
        <div class="row">
            <div class="col-md-12">
                ...
                <nav class="navbar navbar-light navbar-expand-lg navigation-clean-button" style="background: rgba(255,255,255,0);">
                    <div class="container"><a class="navbar-brand" href="#">PESERTA</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow-lg" style="background: rgba(255,255,255,0.4);border-radius: 21px;margin: 35px;">
                    <div class="card-header">
                        <nav class="navbar navbar-light navbar-expand-md">
                            <div class="container-fluid"><a class="navbar-brand" href="#">PESERTA UJIAN</a></div>
                        </nav>
                    </div>
                    <div class="card-body d-flex">
                        <div class="table-responsive" style="width: 1298px;">
                            <table class="table table-striped table-borderless" id="user_data_table">
